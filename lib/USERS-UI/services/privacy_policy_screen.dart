                  ...
                  if (faq.isDocument) ...[
                    ...
                    InkWell(
                      onTap: () {
                        ...
                        String title = faq.question;
                        
                        if (faq.question.contains('Privacy Policy')) {
                          document = CargoDocuments.privacyPolicy;
                        } else if (faq.question.contains('Platform User Agreement')) {
                          document = CargoDocuments.platformUserAgreement;
                        } else if (faq.question.contains('Key Policy')) {
                          document = CargoDocuments.keyPolicy;
                        } else if (faq.question.contains('Vehicle Lease Agreement')) {
