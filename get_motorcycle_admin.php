...
<head>
  ...
  <title>Motorcycle Approval Management | CarGo Admin</title>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <small class="text-muted"><?= htmlspecialchars($row['model']) ?></small><br>
              <small class="badge bg-secondary"><?= htmlspecialchars($row['engine_displacement'] ?? 'N/A') ?></small>
            </td>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  window.viewCarImage = function (imageUrl, carName) {
    ...
    img.src = imageUrl;
    caption.textContent = carName || "Motorcycle Image";
